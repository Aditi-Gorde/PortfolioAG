        ...
        <div className='row'>
            <div className='col'>
                ...
                <div style={{paddingLeft:0}} class="d-grid gap-2 col-6 mx-auto" id="soc">
                   <a href='https://www.linkedin.com/in/aditi-gorde-67797a211/' target="_blank"><button class="btn btn-outline-secondary" type="button" style={{color:'white'}}>LinkedIn</button></a><br />

                    <a target='_blank' href='https://www.instagram.com/aditigorde10/?next=%2F'><button class="btn btn-outline-secondary" type="button" style={{color:'white'}}>Instagram</button></a><br />

                  <a target="_blank" href='https://github.com/Aditi-Gorde'>  <button class="btn btn-outline-secondary" type="button" style={{color:'white'}}>Github</button></a><br />
                </div>
            </div>
